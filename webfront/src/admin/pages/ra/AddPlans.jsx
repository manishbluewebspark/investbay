                ...
                <div className="w-full max-w-full bg-white rounded-xl border border-gray-300">
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <input
                                    type="text"
                                    value={planName}
                                    placeholder="BankNifty Options Intraday"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label className="text-md text-gray-600 font-medium">Discount %(Optinal)</label>
                                <input
                                    type="text"
                                    value={discount}
                                    placeholder="10%"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="text-md text-gray-600 font-medium">Refund Policy(Optinal)</label>
                                <textarea
                                    value={refundPolicy}
