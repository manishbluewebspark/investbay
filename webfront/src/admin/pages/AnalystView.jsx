    ...
    return (
        <div className="">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-full mx-auto">
                <div className="bg-white rounded-2xl overflow-hidden md:col-span-1">
                    {/* IMAGE */}
                    ...
                    {/* CONTENT SECTION */}
                    <div
                        className="p-5 -mt-6 rounded-t-2xl relative z-10"
                        style={{
                    ...
                    >
                        ...
                        <div className="space-y-3 text-sm">
                            {[
                                ...
                                >
                                    <p className="text-gray-500 w-40">{label}</p>
