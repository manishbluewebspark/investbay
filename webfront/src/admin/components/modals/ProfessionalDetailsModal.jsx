          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${isInvalid("sebiNumber") ? "border-red-500" : "border-gray-300"
                  }`}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${isInvalid("specialization") ? "border-red-500" : "border-gray-300"
                  }`}
              />
            </div>
          </div>
    ...
    <p className="text-red-500 text-md mt-1">Please select education/certification</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${isInvalid("experience") ? "border-red-500" : "border-gray-300"
                  }`}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${isInvalid("segment") ? "border-red-500" : "border-gray-300"
                  }`}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${isInvalid("companyName") ? "border-red-500" : "border-gray-300"
                }`}
            />
          </div>
          ...
          <div className="relative">
            ...
            <div
              className={`w-full border rounded-lg px-3 py-2 bg-white focus:outline-none cursor-pointer transition-all duration-200 ${isLanguagesInvalid
                ? "border-red-500"
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <ChevronDown
                  className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${isLanguageDropdownOpen ? "rotate-180" : ""
                    }`}
                />
              </div>
            </div>
                ...
                <div className="p-2 space-y-1">
                  {languageOptions.map((language) => {
                    ...
                    return (
                      <div
                        key={language.value}
                        className={`flex items-center px-3 py-2 rounded-md cursor-pointer transition-colors duration-150 ${isSelected
                          ? "bg-blue-50 text-blue-700"
                          : "hover:bg-gray-50 text-gray-700"
                          }`}
                        onClick={() => handleLanguageToggle(language.value)}
                      >
                        <div className={`w-4 h-4 border rounded mr-3 flex items-center justify-center ${isSelected
          ...
          {/* Upload Section */}
          <div
            className={`border-2 border-dashed p-2 rounded-lg transition-colors ${isFileInvalid ? "border-red-500 bg-red-50" : "border-gray-300 hover:border-gray-400"
              }`}
          >
