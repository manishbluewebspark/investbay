      ...
      <div className="bg-white rounded-2xl p-8 w-full max-w-2xl shadow-2xl relative mx-4 max-h-[90vh] overflow-y-auto 
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-gray-700 mb-1 block">
                Mobile Number As Per PAN Card <span className="text-red-500">*</span>
              </label>
              <input
                type="tel"
                inputMode="numeric"
               ...
               className={`no-spinner w-full border ${errors.mobile ? "border-red-500 focus:border-red-500" : "border-gray-300 focus:border-blue-500"
                } rounded-xl px-1 py-3 pl-5 focus:outline-none focus:ring-2 ${errors.mobile ? "focus:ring-red-200" : "focus:ring-blue-200"
            ...
            <div className="space-y-2">
              ...
              <div className="relative" ref={genderDropdownRef}>
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 text-gray-400 transition-transform duration-200 ${isGenderOpen ? "rotate-180" : ""
                      }`}
                  />
                </button>
                  ...
                  <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-xl shadow-lg z-20 overflow-hidden animate-in fade-in-0 zoom-in-95 duration-200">
                    {genderOptions.map((option) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-left transition-all duration-200 hover:bg-gray-50 flex items-center gap-3 ${form.gender === option.value
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className={`w-full border ${errors.about_us ? "border-red-500" : "border-gray-300"
                } rounded-xl px-4 py-3 focus:outline-none  bg-white/50 backdrop-blur-sm`}
            />
            {errors.about_us && (
              <p className="text-red-500 text-xs mt-1 flex items-center gap-1">
