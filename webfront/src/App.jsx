  ...
  return (
    <Router>
      ...
      <Routes>
            ...
            <>
              ...
              <main className="min-h-screen pt-16">
                <Routes>
                  ...
                  />
                  <Route
                    path="/afterbeforesubscription/:id"
                    element={
                      <PrivateRouteUser>
                        <AfterBeforeSubscription />
                      </PrivateRouteUser>
                    }
                  />
        ...
        />
        <Route
          path="/admin/research-analyst/:id"
          element={
            <PrivateRoute>
              <Layout>
                <AnalystView />
        ...
        />
        <Route
          path="/admin/earnings/course-view"
          element={
            <PrivateRoute>
              <Layout>
                <CourseEarningView />
