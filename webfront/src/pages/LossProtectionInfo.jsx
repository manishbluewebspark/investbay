    ...
    return (
        <div className="border-b border-gray-100 last:border-0">
            <button onClick={() => setOpen(o => !o)} className="w-full flex items-center justify-between py-5 text-left gap-4">
                <span className="font-black text-sm text-gray-900" style={AB}>{q}</span>
                <ChevronDown
                    className="flex-shrink-0 text-gray-400 transition-transform duration-300"
                    style={{ transform: open ? "rotate(180deg)" : "rotate(0deg)", width: 18, height: 18 }}
                />
            </button>
            {open && <p className="pb-5 text-gray-500 text-sm leading-relaxed" style={HS}>{a}</p>}
        </div>
    );
}
        ...
        {[
            ...
            <g key={i}>
                <rect x={c.x} y="106" width={c.label.length > 6 ? 68 : 62} height="28" rx="8"
                    fill={c.active ? "#16a34a" : "#f3f4f6"} stroke={c.active ? "#15803d" : "#e5e7eb"} strokeWidth="1" />
                <text x={c.x + (c.label.length > 6 ? 34 : 31)} y="124" textAnchor="middle"
                    fontSize="10" fontWeight={c.active ? "700" : "500"} fill={c.active ? "white" : "#374151"}>{c.label}</text>
            </g>
        ))}
...
export default function LossProtectionInfo() {
    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            {/* ── HERO ── */}
            <section className="w-full bg-white pt-2 pb-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            >
                                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 mb-5 leading-tight tracking-tight" style={AB}>
                                    Stop Losses Before They{" "}
                                    Stop You.
                                </h1>

                                <p className="text-gray-500 text-base lg:text-lg mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0" style={HS}>
                                ...
                                <div className="flex flex-wrap justify-center lg:justify-start gap-3 mb-8">
                                    {[
                                        ...
                                        <div key={i} className="px-4 py-2 rounded-xl bg-gray-50 border border-gray-100 text-center">
                                            <div className="font-black text-sm text-green-600" style={AB}>{s.val}</div>
                                            <div className="text-[10px] text-gray-400" style={AL}>{s.label}</div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <button
                                    ...
                                    className="group inline-flex items-center gap-2 bg-gray-900 hover:bg-green-600 text-white px-7 py-3.5 rounded-xl font-black text-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
                                    style={AB}
                                >
                                    Set Up Loss Protection
                                    <ArrowRight className="w-4 h-4 transition-transform duration-200 group-hover:translate-x-0.5" />
                                </button>
                                <p className="text-xs text-gray-400 mt-3" style={HS}>Takes under 2 minutes · Free · Cancel anytime</p>
                            </div>
                        </div>
            ...
            <section className="w-full bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-4 pt-4">
                        <span className="text-[11px] font-semibold tracking-[0.15em] uppercase text-gray-400" style={AL}>How It Works</span>
                    </div>
                    <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-2 leading-tight tracking-tight" style={AB}>
                        3 steps. That's it.
                    </h2>
                    <p className="text-gray-500 text-base mb-0" style={HS}>
                        ...
                        return (
                            ...
                            >
                                <div className="flex-1 w-full max-w-[440px]">
                                    <span className="block mb-4 text-6xl md:text-7xl lg:text-8xl font-black text-gray-100 leading-none" style={AB}>
                                        {step.num}
                                    </span>
                                    <h3 className="text-2xl md:text-3xl font-black text-gray-900 mb-4 leading-snug tracking-tight" style={AB}>
                                        {step.title}
                                    </h3>
                                    <p className="text-gray-500 text-sm md:text-base mb-8 leading-relaxed" style={HS}>
                                        {step.desc}
                                    </p>
                                    <button
                                        onClick={() => navigate(step.path)}
                                        className="group inline-flex items-center gap-2 bg-gray-900 hover:bg-green-600 text-white px-6 py-3 rounded-xl font-black text-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
                                        style={AB}
                                    >
                                        {step.cta}
                                        <ArrowRight className="w-4 h-4 transition-transform duration-200 group-hover:translate-x-0.5" />
                                ...
                                <div className="flex-1 w-full max-w-[500px]">
                                    <div className="w-full aspect-[460/360]"><Illustration /></div>
                                </div>
                            </div>
                        );
                    })}
            ...
            <section className="w-full bg-gray-50 py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    <span className="text-[11px] font-semibold tracking-[0.15em] uppercase text-gray-400 block mb-3" style={AL}>Why It Matters</span>
                    <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-10 leading-tight tracking-tight" style={AB}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        {[
                            ...
                            <div key={i} className="bg-white rounded-2xl p-6 border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
                                <div className="w-10 h-10 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-center mb-4">
                                    <item.icon className="w-5 h-5 text-gray-600" strokeWidth={1.8} />
                                </div>
                                <h4 className="font-black text-sm text-gray-900 mb-1.5" style={AB}>{item.title}</h4>
            ...
            <section className="w-full bg-white py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-5xl mx-auto">
                    <span className="text-[11px] font-semibold tracking-[0.15em] uppercase text-gray-400 block mb-3" style={AL}>Supported Brokers</span>
                    <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-10 leading-tight tracking-tight" style={AB}>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center justify-center py-8 px-4 rounded-2xl border border-gray-100 hover:border-gray-200 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg cursor-default" style={{ background: b.bg }}>
                                <span className="font-black text-base" style={{ ...AB, color: b.col }}>{b.name}</span>
                                <span className="text-[10px] text-gray-400 mt-1" style={AL}>Supported</span>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="w-full bg-gray-50 py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    <span className="text-[11px] font-semibold tracking-[0.15em] uppercase text-gray-400 block mb-3" style={AL}>FAQ</span>
                    <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-2 leading-tight tracking-tight" style={AB}>
                        Priority Support. No bots.
                    </h2>
                    <p className="text-gray-500 text-base mb-10" style={HS}>Get answers to common questions below.</p>
            ...
            <section className="w-full bg-white py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-xl mx-auto text-center">
                    <div className="w-16 h-16 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center mx-auto mb-6">
                        <Shield className="w-8 h-8 text-gray-600" strokeWidth={1.6} />
                    </div>
                    <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4 leading-tight tracking-tight" style={AB}>
                        Ready to Protect Your Portfolio?
                    </h2>
                    <p className="text-gray-500 text-base mb-8 leading-relaxed" style={HS}>
                        Connect your broker and set your loss limit in under 2 minutes. Trade with confidence knowing your downside is protected.
                    </p>
                    <button
                        onClick={() => navigate("/loss-protection/setup")}
                        className="group inline-flex items-center gap-2 bg-black hover:bg-gray-800 text-white px-8 py-4 rounded-xl font-black text-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
                        style={AB}
                    >
                        Set Up Loss Protection
                        <ArrowRight className="w-4 h-4 transition-transform duration-200 group-hover:translate-x-0.5" />
                    </button>
                    <p className="text-xs text-gray-400 mt-4" style={HS}>Takes under 2 minutes · Free · Cancel anytime</p>
