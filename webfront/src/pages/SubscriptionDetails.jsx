        ...
        return (
            <div className="min-h-screen bg-[#060b10] flex items-center justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-400 text-sm font-medium">Loading plan details...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-[#060b10] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-red-400 text-sm font-medium mb-2">No plan data available.</p>
                    <button
                        onClick={() => navigate(-1)}
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-6">
                        ...
                        <div className="group/card relative bg-white/[0.02] backdrop-blur-sm border border-white/[0.06] rounded-2xl p-6 transition-all duration-300 hover:border-emerald-500/20">
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
                                <h3 className="text-xl font-bold text-[#f0f4f8]">Plan Details</h3>
                                <button
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-2">
                                                    <p className="text-base font-bold text-[#f0f4f8]">{analyst?.name}</p>
