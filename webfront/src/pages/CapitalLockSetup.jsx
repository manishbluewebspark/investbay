    ...
    <section className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900" style={AB}>Capital Lock Setup</h1>
            <p className="text-sm text-gray-500" style={HS}>Configure your investment protection</p>
          </div>
        </div>

        {/* Alerts */}
        {error && (
          <div className="flex items-center gap-3 mb-4 px-4 py-3 bg-red-50 border border-red-200 rounded-xl text-sm text-red-600" style={HS}>
            <FaTimesCircle className="shrink-0" />{error}
            <button className="ml-auto hover:text-red-800" onClick={() => setError("")}>✕</button>
          </div>
        )}
        {success && (
          <div className="flex items-center gap-3 mb-4 px-4 py-3 bg-green-50 border border-green-200 rounded-xl text-sm text-green-700" style={HS}>
        ...
        {lockData?.is_active ? (
          <div className="space-y-4">
            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-bold text-gray-900" style={AB}>Capital Lock Active</h2>
                <span className="flex items-center gap-1.5 text-xs font-medium text-green-700 bg-green-50 border border-green-200 px-3 py-1.5 rounded-full" style={HS}>
                  <FaLock size={10} /> Locked
                </span>
              </div>

              <div className="text-center py-10 bg-green-50 rounded-2xl mb-6 border border-green-100">
                <p className="text-xs text-gray-500 mb-2 uppercase tracking-wider" style={HS}>Maximum Investment Cap</p>
                <p className="text-5xl font-black text-green-600" style={AB}>₹{fmt(lockData.locked_amount)}</p>
                <p className="text-xs text-gray-500 mt-3" style={HS}>
              ...
              <div className="flex items-start gap-2 px-4 py-3 bg-green-50 border border-green-100 rounded-xl mb-6">
                ...
                <p className="text-xs text-gray-600 leading-relaxed" style={HS}>
          ...
          /* Set lock card */
          <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-gray-900 mb-1" style={AB}>Set your capital limit</h2>
            <p className="text-sm text-gray-500 mb-6" style={HS}>
            ...
            <div className="flex items-start gap-2 px-4 py-3 bg-blue-50 border border-blue-100 rounded-xl mb-5">
              ...
              <p className="text-xs text-blue-700 leading-relaxed" style={HS}>
            ...
            <div className="relative mb-4">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-medium text-lg" style={AL}>₹</span>
              <input
                type="number"
                value={amount}
            ...
            {amount && Number(amount) > 0 && (
              <div className="p-4 rounded-xl bg-green-50 border border-green-100 mb-5">
                <p className="text-sm text-gray-600" style={HS}>
            ...
            {!showConfirm ? (
              <button
                ...
                className="w-full py-3.5 bg-gray-900 hover:bg-gray-800 text-white rounded-xl text-sm font-bold transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-lg"
                style={AB}
              >
              ...
              <div className="border border-green-200 rounded-xl p-5 bg-green-50">
                <p className="text-sm font-semibold text-green-800 mb-4 text-center" style={AB}>
            ...
            <div className="flex items-start gap-3 mt-5 px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl">
              ...
              <p className="text-xs text-gray-500 leading-relaxed" style={HS}>
