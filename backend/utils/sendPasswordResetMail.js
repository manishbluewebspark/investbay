...
export const sendOTPEmail = async (to, code) => {
  return transporter.sendMail({
    ...
    html: generateLoginOTPTemplate(code),
  });
};


const generateLoginOTPTemplate = (code) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Login OTP - InvestBay</title>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600&display=swap');
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p class="message">
                You're trying to login to your InvestBay account. 
            ...
            <div class="security-note">
                <p>
                    ...
                    InvestBay will never ask for your OTP via phone or email.
                </p>
            </div>
            
            <p class="message">
                If you didn't request this OTP, please ignore this email or 
                <a href="mailto:support@investbay.com" style="color: #667eea;">contact our support team</a> immediately.
            </p>
        </div>
        
        <div class="footer">
            <p>This is an automated message from InvestBay Security System.</p>
            <p>© ${new Date().getFullYear()} InvestBay. All rights reserved.</p>
...
export const sendPasswordEmail = async (to, password, name) => {
  return transporter.sendMail({
    from: `"InvestBay" <${process.env.EMAIL_USER}>`,
    to,
    subject: "Your InvestBay Account Password",
    html: generatePasswordEmailTemplate(password, name),
  });
};

const generatePasswordEmailTemplate = (password, name) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Your InvestBay Account Password</title>
    <style>
        /* Same CSS as before, just update the content */
        .password {
            font-size: 24px;
            font-weight: 700;
            color: #d84315;
...
<body>
    <div class="email-container">
        <div class="content">
            ...
            <p class="message">
                Welcome to InvestBay! Your account has been successfully created. 
            ...
            <div class="password-container">
                ...
                <p style="color: #5d4037; font-size: 14px;">
                    Use this password along with your email to login
                </p>
            </div>
            ...
            <p class="message">
                For security, please:
                <ol>
                    <li>Login immediately using this password</li>
